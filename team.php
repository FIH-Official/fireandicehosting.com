...
<?php require_once ("./php_include/nav-bar.php");?>
	...
	<section class="team-area section-padding">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="0.8s">
					<div class="single-team">
				...
				<div class="col-lg-3 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="0.9s">
					<div class="single-team">
				...
				<div class="col-lg-3 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="1s">
					<div class="single-team">
				...
				<div class="col-lg-3 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="1.1s">
					<div class="single-team">
						<img src="assets/images/team8.png" alt="">
						<h4>Adan Pagana</h4>
						<p>Ceo & Founder</p>
						<div class="team-social">
							<a href=""><i class="fa fa-facebook"></i></a>
	...
	<!--Testimonial Area-->
	<section class="testimonial-area gray-bg section-padding">
		<div class="container">
			<div class="row">
				<div class="col-lg-5">
